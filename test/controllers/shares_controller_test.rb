...
class SharesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post shares_url, params: { share: { description: @share.description, image: @share.image, title: @share.title, user_id: @share.user_id, view_count: @share.view_count } }
    end
  ...
  test "should update share" do
    patch share_url(@share), params: { share: { description: @share.description, image: @share.image, title: @share.title, user_id: @share.user_id, view_count: @share.view_count } }
