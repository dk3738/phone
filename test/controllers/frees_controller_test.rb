...
class FreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create free" do
    assert_difference('Free.count') do
      post frees_url, params: { free: { description: @free.description, title: @free.title, user_id: @free.user_id, view_count: @free.view_count } }
    end
  ...
  test "should update free" do
    patch free_url(@free), params: { free: { description: @free.description, title: @free.title, user_id: @free.user_id, view_count: @free.view_count } }
